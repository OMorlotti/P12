...
public class ArtistsController
{
	...
	public String addUpdateArtists(@Valid @ModelAttribute("artist") Artist artist, BindingResult result, Model model) // BindingResult = test erreur remplissage du bean
	{
		if(!result.hasErrors())
		{
			try
